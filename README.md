...
Title: Top Down Desktop Video Game
...
Possible Features:
* Top down camera angle/birds-eye-view.
* Basic controls - Player can run, jump, slide, crouch, and shoot.
* Tower spawns enemies to attack player
* Player destroys tower to win.
